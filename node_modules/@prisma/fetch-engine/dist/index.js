...
__export(index_exports, {
  ...
  download: () => import_chunk_GRUBMFLQ.download,
  engineEnvVarMap: () => import_chunk_QFA3XBMW.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_QFA3XBMW.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_GRUBMFLQ.getBinaryName,
  getCacheDir: () => import_chunk_LONQL55G.getCacheDir,
  getProxyAgent: () => import_chunk_VAPNG6TS.getProxyAgent,
  getVersion: () => import_chunk_GRUBMFLQ.getVersion,
  maybeCopyToTmp: () => import_chunk_GRUBMFLQ.maybeCopyToTmp,
  overwriteFile: () => import_chunk_LONQL55G.overwriteFile,
  plusX: () => import_chunk_GRUBMFLQ.plusX,
  vercelPkgPathRegex: () => import_chunk_GRUBMFLQ.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_GRUBMFLQ = require("./chunk-GRUBMFLQ.js");
